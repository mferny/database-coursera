...
LogicalOperationNode::LogicalOperationNode(const LogicalOperation &op, const std::shared_ptr<Node> &lhs,
                                           const std::shared_ptr<Node> &rhs) : op_(op), lhs_(lhs), rhs_(rhs) {}
